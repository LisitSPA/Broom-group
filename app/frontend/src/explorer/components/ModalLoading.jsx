...
export const ModalLoading = () => {
  return (
    <div className="flex items-center justify-center w-screen h-screen fixed bg-black/60 z-50 backdrop-blur-sm">
      <div className="bg-white space-x-3 w-4/5 flex justify-center items-center min-h-[504px] p-5 rounded-md shadow-lg relative">
        <svg
          version="1.1"
          id="Layer_1"
          ...
          xml:space="preserve"
          className="animate-spin duration-[4s] fill-gray-400 w-[30px] h-auto"
        >
          <g>
            <path
              fill-rule="evenodd"
